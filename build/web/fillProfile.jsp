<%-- 
    ...
    Created on : 2014-11-13, 12:22:56
    Author     : yanyanzhou
--%>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <ul class="nav navbar-nav navbar-right">
                            <li><a href="#"><i class="fa fa-btn "></i>Post</a></li>
                            <li><a href="#"><i class="fa fa-btn "></i>Feed</a></li>
                            <li><a href="#"><i class="fa fa-btn "></i>Search</a></li>
                            <li><a href="Profile?command=showProfile"><i class="fa fa-btn "></i>Profile</a></li>
