<%-- 
    Document   : search
    Created on : Nov 27, 2013, 11:30:03 AM
    Author     : birui
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-offset-1 col-lg-2" style="margin-top: 3%; margin-left: 5%;">
                ...
                <!--Post Section-->
                <div class="col-lg-8" style="margin-top: 3%; margin-left: 5%; padding-right: 5%; padding-bottom: 2%">
                            ...
                            <div class="panel panel-default" style="padding-top: 3%; margin-bottom: 3%">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row" >
                                        ...
                                        <div class="col-sm-2">
                                            <button id="submitButton" type="button" name="submitButton" class="btn btn-block btn-primary btn-vote" onclick="updateLike(<%=postinfo.getPostId()%>)"><span class="glyphicon glyphicon-heart"> </span>&nbsp Like <span id="badge_<%=postinfo.getPostId()%>" class="badge"><%int likeCount = post.getLike(postinfo.getPostId());%><%=likeCount%></span></button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div id="<%=postinfo.getPostId()%>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                                            <div class="well comment" id="<%=bigComment%>">
                                                ...
                                                %>        
                                                <!--Comment Place-->  
                                                <div class="row col-lg-10 col-lg-offset-1" id="commentDiv" style="Background-color: #ffffff; margin-bottom: 2%">
                                                    <div class="col-lg-4 col-lg-offset-8 cTime">
                                                        <p><%=dateString%></p>
                                                    </div>
                                                    <div class="col-lg-1 cUsername">
